...
%  Workshop "Interaktive OER mit LiaScript erstellen", Potsdam 2026
...
\begin{minipage}[c]{0.20\linewidth}\raggedright
  {\sffamily\scriptsize\color{white!85}\faGraduationCap~~Workshop~$\cdot$~Potsdam 2026}\\[2pt]
...
\faGithub~Quellcode: \textbf{github.com/LiaPlayground/Cowork\_Tutorial\_2026}}
...
\end{minipage}\hfill
\begin{minipage}[c]{0.10\linewidth}\centering
  {\color{black}\colorbox{white}{\hspace{1pt}\qrcode[height=1.55cm,nolinks]{https://github.com/LiaPlayground/Cowork_Tutorial_2026}\hspace{1pt}}}\\[1pt]
...
$\bullet$~\href{https://github.com/LiaTemplates/Pyodide}{\texttt{Pyodide}}~–~Python\\
$\bullet$~\href{https://github.com/LiaTemplates/Skulpt}{\texttt{Skulpt}}~–~Python (leichter)\\
$\bullet$~\href{https://github.com/LiaTemplates/Lua}{\texttt{Lua}}~–~Lua\\
$\bullet$~\href{https://github.com/LiaTemplates/JSCPP}{\texttt{JSCPP}}~–~C++\\
$\bullet$~\href{https://github.com/LiaTemplates/Tau-Prolog}{\texttt{Tau-Prolog}}~–~Prolog
\end{minipage}\hfill
\begin{minipage}[t]{0.24\linewidth}
\textbf{\color{liagreen}\faChartBar~~Visualisieren}\\[1pt]
$\bullet$~\href{https://github.com/LiaTemplates/mermaid_template}{\texttt{mermaid\_template}}~–~Diagramme\\
$\bullet$~\href{https://github.com/LiaTemplates/JSXGraph}{\texttt{JSXGraph}}~–~Mathematik\\
$\bullet$~\href{https://github.com/LiaTemplates/Vega}{\texttt{Vega}}~–~Datenvisualisierung\\
$\bullet$~\href{https://github.com/LiaTemplates/Tikz-Jax}{\texttt{Tikz-Jax}}~–~Tikz-Grafiken\\
$\bullet$~\href{https://github.com/LiaTemplates/ABCjs}{\texttt{ABCjs}}~–~Musiknotation
\end{minipage}\hfill
\begin{minipage}[t]{0.24\linewidth}
\textbf{\color{liagreen}\faDatabase~~Daten \& Bibliothek}\\[1pt]
$\bullet$~\href{https://github.com/LiaTemplates/citations}{\texttt{citations}}~–~BibTeX/CSL\\
$\bullet$~\href{https://github.com/LiaTemplates/Wikimedia}{\texttt{Wikimedia}}~–~Commons-Einbettung\\
$\bullet$~\href{https://github.com/LiaTemplates/Comunica}{\texttt{Comunica}}~–~SPARQL / Linked Data\\
$\bullet$~\href{https://github.com/LiaTemplates/AlaSQL}{\texttt{AlaSQL}}~/~\href{https://github.com/LiaTemplates/SQLite}{\texttt{SQLite}}~–~SQL\\
$\bullet$~\href{https://github.com/LiaTemplates/Random}{\texttt{Random}}~–~Quiz-Banken
\end{minipage}\hfill
\begin{minipage}[t]{0.24\linewidth}
\textbf{\color{liagreen}\faGithub~~Übersicht}\\[1pt]
$\bullet$~\href{https://github.com/LiaTemplates}{\texttt{github.com/LiaTemplates}}\\
$\bullet$~\href{https://github.com/LiaTemplates/Index}{\texttt{github.com/LiaTemplates/Index}}\\
$\bullet$~\href{https://github.com/LiaPlayground}{\texttt{github.com/LiaPlayground}}\\
$\bullet$~Live-Editor:\\
\hspace*{0.6em}\href{https://liascript.github.io/LiveEditor/}{\texttt{liascript.github.io/LiveEditor}}
\end{minipage}
\end{liainfo}
...
\faGithub~\href{https://github.com/LiaScript}{\textbf{github.com/LiaScript}} \quad
CC-BY-SA 4.0 — Sebastian Zug, Potsdam 2026}
